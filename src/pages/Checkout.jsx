    ...
    return (
      <div className="min-h-screen bg-mochi-cream flex flex-col items-center justify-center text-center px-4">
        ...
        >
          ...
          <p className="text-mochi-navy/70 mb-8">Thank you for your purchase. You can track your order status in your account dashboard.</p>
          <button 
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm border border-mochi-sky/50">
              ...
              <form id="checkout-form" onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="block text-xs font-bold uppercase tracking-widest mb-2 text-mochi-navy/70">Postal Code</label>
                    <input 
                      required 
                      pattern="\d{4}"
                      maxLength="4"
                      ...
                      onChange={e => {
                        ...
                        if(val.length <= 4) setFormData({...formData, shippingZipCode: val});
                      }}
                    />
                  </div>
                </div>
