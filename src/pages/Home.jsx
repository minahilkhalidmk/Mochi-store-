    ...
    <div className="text-mochi-navy min-h-screen selection:bg-mochi-teal selection:text-white font-sans overflow-hidden">
      ...
      <section id="story" className="relative z-20 bg-mochi-navy py-40 px-8 flex items-center justify-center">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-xs tracking-[0.3em] uppercase text-mochi-sky mb-8">The Mochi Story</h2>
          <h3 className="text-3xl md:text-5xl lg:text-6xl font-light leading-tight tracking-tight mb-12 text-mochi-cream">
            "We believe that everyday objects should be extraordinary. Design is not just how it looks, but how it feels."
          </h3>
          <p className="text-mochi-sky max-w-2xl mx-auto font-light leading-relaxed mb-12">
            Born from a desire to bridge the gap between high-end aesthetics and accessible commerce, Mochi represents a new paradigm in digital retail. Every detail, from the typography to the motion of the page, is crafted with cinematic intention.
          </p>
