    ...
    const fetchProduct = async () => {
      try {
        ...
        if (snapshot.exists()) {
          ...
          const mappedProducts = productList.map((p, index) => ({
            ...p,
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          <div className="w-full lg:w-[55%]">
            <div className="sticky top-32 flex gap-4">
              ...
              {/* Main Image */}
              <div className="w-full bg-white/50 border border-mochi-sky rounded-lg relative overflow-hidden group shadow-sm pt-[100%]">
                <img 
