    ...
    const fetchOrders = async () => {
      try {
        ...
        if (snapshot.exists()) {
          ...
          // Note: Here we would ideally filter by user, but since the original didn't
          // pass a userId for history, we just get all for this demo or we'd filter if we had auth hooked in to it.
