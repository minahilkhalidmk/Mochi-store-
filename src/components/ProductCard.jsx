...
export default function ProductCard({ product, layout, variants, initial, animate, exit }) {
  ...
  return (
    ...
    >
      ...
      <div className="bg-gray-100 w-full relative pt-[100%] overflow-hidden">
        {product.majorImageUrl ? (
          <img src={product.majorImageUrl} alt={product.title} className="absolute inset-0 w-full h-full object-cover" />
        ) : (
